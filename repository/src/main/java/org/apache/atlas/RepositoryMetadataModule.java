...
import org.apache.atlas.services.*;
...
public class RepositoryMetadataModule extends com.google.inject.AbstractModule {
    ...
    protected void configure() {
        ...
        bind(IDtLineageService.class).to(DtLineageService.class).asEagerSingleton();

        bind(OrganizationService.class).to(DefaultOrganizationService.class).asEagerSingleton();

        bind(DataMapService.class).to(DefaultDataMapService.class).asEagerSingleton();
