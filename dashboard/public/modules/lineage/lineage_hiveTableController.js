...
angular.module('dgc.lineage').controller('Lineage_hiveTableController', ['$element', '$scope', '$state', '$stateParams', 'lodash', 'LineageResource', 'd3', 'DetailsResource', '$q',
    function($element, $scope, $state, $stateParams, _, LineageResource, d3, DetailsResource, $q) {
        ...
        $scope.tableName = $scope.$parent.tableName;
