...
angular.module('dgc.lineage').controller('Lineage_dt_stController', ['$element', '$scope', '$state', '$stateParams', 'lodash', 'LineageResource', 'd3', 'DetailsResource', '$q',
        ...
        function transformData(metaData) {
            ...
            function getLoadProcessTypes(guid) {
                ...
                angular.forEach(guidsList, function(value) {
                    if (value.id.id === guid) {
                        if (typeof value.values.name !== "undefined") {
            ...
            function update(source) {
                ...
                nodeEnter.append("image")
                    ...
                    .attr("xlink:href", function(d) {
                        return d.type === 'DataField' ? '../img/tableicon.png' : '../img/process.png';
                    })
                ...
                node.select("image.nodeImage")
                    ...
                    .attr("xlink:href", function(d) {
                        if (d._children) {
                            return d.type === 'DataField' ? '../img/tableicon1.png' : '../img/process1.png';
                        }
                        return d.type === 'DataField' ? '../img/tableicon.png' : '../img/process.png';
                    });
