...
angular.module('dgc.lineage').controller('Lineage_dbController', ['$element', '$scope', '$state', '$stateParams', 'lodash', 'LineageResource', 'd3', 'DetailsResource', '$q',
    function($element, $scope, $state, $stateParams, _, LineageResource, d3, DetailsResource, $q) {
        ...
        function getCombinedLineageData(dbData, callRender) {
            LineageResource.queryDataContainerIO({
        ...
        $scope.type = $element.parent().attr('data-db-type');
            ...
            function update(source) {
                ...
                nodeEnter.append("image")
                    ...
                    .attr("xlink:href", function(d) {
                        return d.type === 'DataContainer' ? '../img/database.png' : '../img/process.png';
                    })
                ...
                node.select("image.nodeImage")
                    ...
                    .attr("xlink:href", function(d) {
                        if (d._children) {
                            return d.type === 'DataContainer' ? '../img/database1.png' : '../img/process1.png';
                        }
                        return d.type === 'DataContainer' ? '../img/database.png' : '../img/process.png';
                    });
