...
angular.module('dgc.lineage').controller('Lineage_dataTableController', ['$element', '$scope', '$state', '$stateParams', 'lodash', 'LineageResource', 'd3', 'DetailsResource', '$q',
    function($element, $scope, $state, $stateParams, _, LineageResource, d3, DetailsResource, $q) {
        ...
        function getCombinedLineageData(tableData, callRender) {
            LineageResource.queryDataTableIO({
                qualifiedName: tableData.qualifiedName,
            ...
            function update(source) {
                ...
                nodeEnter.append("image")
                    ...
                    .attr("xlink:href", function(d) {
                        return d.type === 'DataTable' ? '../img/tableicon.png ' : '../img/process.png';
                    })
                    .on('mouseover', function(d) {
                        if (d.type === 'LineageProcess' || 'DataTable') {
                            tooltip.show(d);
                        }
                    })
                ...
                node.select("image.nodeImage")
                    ...
                    .attr("xlink:href", function(d) {
                        if (d._children) {
                            return d.type === 'DataTable' ? '../img/tableicon1.png ' : '../img/process1.png';
                        }
                        return d.type === 'DataTable' ? '../img/tableicon.png ' : '../img/process.png';
                    });
