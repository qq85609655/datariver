...
angular.module('dgc.lineage').controller('Lineage_dt_psController', ['$element', '$scope', '$state', '$stateParams', 'lodash', 'LineageResource', 'd3', 'DetailsResource', '$q',
            ...
            function update(source) {
                ...
                nodeEnter.append("image")
                    ...
                    .attr("xlink:href", function(d) {
                        return d.type === 'step' ? '../img/tableicon.png' : '../img/process.png';
                    })
                ...
                node.select("image.nodeImage")
                    ...
                    .attr("xlink:href", function(d) {
                        if (d._children) {
                            return d.type === 'step' ? '../img/tableicon1.png' : '../img/process1.png';
                        }
                        return d.type === 'step' ? '../img/tableicon.png' : '../img/process.png';
                    });
