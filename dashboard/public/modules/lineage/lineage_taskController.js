...
angular.module('dgc.lineage').controller('Lineage_taskController', ['$element', '$scope', '$state', '$stateParams', 'lodash', 'LineageResource', 'd3', 'DetailsResource', '$q',
            ...
            function update(source) {
                ...
                nodeEnter.append("image")
                    ...
                    .attr("xlink:href", function(d) {
                        return d.type === 'step' ? '../img/task.png' : '../img/process.png';
                    })
                ...
                node.select("image.nodeImage")
                    ...
                    .attr("xlink:href", function(d) {
                        if (d._children) {
                            return d.type === 'step' ? '../img/task1.png' : '../img/process1.png';
                        }
                        return d.type === 'step' ? '../img/task.png' : '../img/process.png';
                    });
