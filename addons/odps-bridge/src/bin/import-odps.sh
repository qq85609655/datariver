...
JAVA_PROPERTIES="$METADATA_OPTS -Datlas.log.dir=$METADATA_LOG_DIR -Datlas.log.file=import-odps.log -Dlog4j.configuration=atlas-log4j.xml"
shift
...
${JAVA_BIN} ${JAVA_PROPERTIES} -cp ${ODPS_CP}:${METADATACPPATH} org.apache.atlas.odps.bridge.OdpsMetaStoreBridge
