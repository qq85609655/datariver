 ...
 * @date 2015/11/4 9:59
 */
public class WorkflowJsonToBean {

    private static String WORKFLOW_WORKSPACE_NAME = "workspaceName";
    ...
    static {
        WF_ACTION.put("getCred", new Property(JsonTags.WORKFLOW_ACTION_AUTH, String.class));
        ...
        WF_JOB.put("getWorkspaceName", new Property(WORKFLOW_WORKSPACE_NAME, String.class));
        ...
        WF_JOB.put("getStatus", new Property(JsonTags.WORKFLOW_STATUS, org.apache.oozie.client.WorkflowJob.Status.class));
        ...
        BULK_RESPONSE.put("getCoordinator",
            new Property(JsonTags.BULK_RESPONSE_COORDINATOR, CoordinatorJob.class, false));
        BULK_RESPONSE.put("getAction", new Property(JsonTags.BULK_RESPONSE_ACTION, CoordinatorAction.class, false));

        JMS_CONNECTION_INFO.put("getTopicPatternProperties",
            new Property(JsonTags.JMS_TOPIC_PATTERN, Properties.class));
    ...
    private static class JsonInvocationHandler implements InvocationHandler {
        ...
        private Object parseType(Class type, Object obj) {
            if (type == String.class) {
                ...
                return parseDateRfc822((String) obj);
            } else if (type.isEnum()) {
        ...
        static Date parseDateRfc822(String str) {
            if (str != null) {
                try {
                    /*SimpleDateFormat ex = new SimpleDateFormat("EEE, dd MMM yyyy HH:mm:ss \'GMT\'", Locale.US);
                    ex.setTimeZone(TimeZone.getTimeZone("GMT"));*/
    ...
    public static WorkflowAction createWorkflowAction(JSONObject json) {
        return (WorkflowAction) Proxy.newProxyInstance(WorkflowJsonToBean.class.getClassLoader(),
     ...
     */
    public static WorkflowExtendsJob createWorkflowJob(JSONObject json) {
        return (WorkflowExtendsJob) Proxy.newProxyInstance(WorkflowJsonToBean.class.getClassLoader(),
            new Class[]{WorkflowExtendsJob.class},
     ...
     */
    public static List<WorkflowExtendsJob> createWorkflowJobList(JSONArray json) {
        List<WorkflowExtendsJob> list = new ArrayList<WorkflowExtendsJob>();
        for (Object obj : json) {
    ...
    public static CoordinatorAction createCoordinatorAction(JSONObject json) {
        return (CoordinatorAction) Proxy.newProxyInstance(WorkflowJsonToBean.class.getClassLoader(),
    ...
    public static CoordinatorJob createCoordinatorJob(JSONObject json) {
        return (CoordinatorJob) Proxy.newProxyInstance(WorkflowJsonToBean.class.getClassLoader(),
    ...
    public static JMSConnectionInfo createJMSConnectionInfo(JSONObject json) {
        final JMSConnectionInfoWrapper jmsInfo = (JMSConnectionInfoWrapper) Proxy.newProxyInstance(
            WorkflowJsonToBean.class.getClassLoader(), new Class[]{JMSConnectionInfoWrapper.class},
    ...
    public static BundleJob createBundleJob(JSONObject json) {
        return (BundleJob) Proxy.newProxyInstance(WorkflowJsonToBean.class.getClassLoader(),
    ...
    public static BulkResponse createBulkResponse(JSONObject json) {
        return (BulkResponse) Proxy.newProxyInstance(WorkflowJsonToBean.class.getClassLoader(),
