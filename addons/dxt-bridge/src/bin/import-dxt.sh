...
JAVA_PROPERTIES="$METADATA_OPTS -Datlas.log.dir=$METADATA_LOG_DIR -Datlas.log.file=import-dxt.log -Dlog4j.configuration=atlas-log4j.xml"
shift
...
${JAVA_BIN} ${JAVA_PROPERTIES} -cp ${DXT_CP}:${METADATACPPATH} org.apache.atlas.dxt.bridge.DxtMetaStoreBridge
