...
ALL_BRIDGES="dxt-bridge odps-bridge workflow-bridge"
ALL_BRIS="dxt odps workflow"
...
for bridge in ${BRIDGES}; do
    ...
    dxt-bridge | dxt)
        BRIDGE_DIR=dxt
        MAIN_CLASS=org.apache.atlas.dxt.examples.DxtQuickStart
        ;;
    odps-bridge | odps)
        BRIDGE_DIR=odps
        MAIN_CLASS=org.apache.atlas.odps.examples.OdpsQuickStart
        ;;
    workflow-bridge | workflow)
        BRIDGE_DIR=workflow
        MAIN_CLASS=org.apache.atlas.workFlow.examples.WorkflowQuickStart
        ;;
    *)
    ...
    LOG_FILE=import-demo-${BRIDGE_DIR}.log
