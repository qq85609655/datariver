...
public class HiveLineageResource {
     ...
     *     获取Hive表的输入血缘关系。<br/>
     *     <br/>
     *     http://localhost:21000/api/atlas/lineage/hive/table/{tableName}/inputs/graph<br/>
    ...
    @org.codehaus.enunciate.jaxrs.TypeHint(HiveLineageResource.class)
     ...
     *     获取Hive表的输出血缘关系。<br/>
     *     <br/>
     *     http://localhost:21000/api/atlas/lineage/hive/table/{tableName}/outputs/graph<br/>
     *     @param tableName 表的名称
     *     @return JSON。
     * </p>
     */
     ...
     *     获取Hive表的schema信息。<br/>
     *     <br/>
     *     http://localhost:21000/api/atlas/lineage/hive/table/{tableName}/schema<br/>
     *     @param tableName 表的名称
     *     @return JSON。
     * </p>
     */
