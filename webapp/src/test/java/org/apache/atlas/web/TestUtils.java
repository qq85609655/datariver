...
public class TestUtils {
    ...
    public static String getTempDirectory() {
        ...
        if (projectBaseDirectory == null) {
            try {
                projectBaseDirectory = new File("").getCanonicalPath();
            } catch (IOException e) {
                e.printStackTrace();
            }
        }
        return projectBaseDirectory + "/webapp/target/" + random();
    }
    ...
    public static String getWarPath() {
        ...
        return projectBaseDirectory + String.format("/webapp/target/atlas-webapp-%s",
