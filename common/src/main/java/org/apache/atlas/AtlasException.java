...
public class AtlasException extends Exception {
    ...
    public AtlasException(ErrorEnum errorEnum,Object... params) {
        super(errorEnum.getMsg(params));
    }
    public AtlasException(ErrorEnum errorEnum,Throwable cause, Object... params) {
        super(errorEnum.getMsg(params), cause);
    }
